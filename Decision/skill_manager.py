    ...
    return [
        {
            ...
            "action_sequences_length": s.get("action_sequences_length", 0),
            "actions": s.action_sequences[0].get("sub_actions_seq", []) if s.action_sequences else []
        }
...
def build_skill_context(skill_name: str, next_sequence_index: int = 0) -> str:
    ...
    actions = next_seq.get("sub_actions_seq", [])
